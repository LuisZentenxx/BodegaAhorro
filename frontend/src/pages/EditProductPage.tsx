...
const EditProductPage = () => {
        ...
        return (
            ...
            cursor-pointer bg-gray-40 ${isHovered ? "bg-gray-600" : "hover:bg-gray-600"
                                ...
                                <button
                                    type="submit"
                                    className="text-white font-semibold inline-flex items-center bg-red-800 dark:bg-gray-200 dark:text-slate-800 hover:bg-red-700 hover:font-bold focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-blue-100 dark:focus:ring-primary-800"
                                >
                                    <svg
